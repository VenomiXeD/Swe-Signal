...
public class SwItems {
	...
	public static final RegistryObject<BlockItem> ITEM_SW_SIGNAL_BOX = ITEMS.register("sw_signal_box",
			() -> new BlockItem(SwBlocks.BLOCK_SW_SIGNAL_BOX.get(), new Item.Properties()));
	...
	public static final RegistryObject<BlockItem> ITEM_THREE_LIGHT_DISTANT_SIGNAL = ITEMS.register(
			"sw_3l_distant_signal",
			() -> new BlockItem(SwBlocks.BLOCK_MODERN_THREE_LIGHT_DISTANT_SIGNAL.get(), new Item.Properties()));
	...
	public static final RegistryObject<BlockItem> ITEM_U_SIGN = ITEMS.register("sw_u_sign",
			() -> new TrackTargetingBlockItem(SwBlocks.BLOCK_U_SIGN.get(), new Item.Properties(),
