...
public class SeBlocks {
	...
	public static final BlockEntry<BlockRailroadCrossingDistantSignal> BLOCK_RAILROAD_CROSSING_DISTANT_SIGNAL = SwBlocks.modelledBlock(
			"signals.se.3l_distant_railroad_crossing_signal", BlockRailroadCrossingDistantSignal::new
	);
	public static final BlockEntry<BlockCrossingGate> BLOCK_CROSSING_GATE = SwBlocks.modelledBlock(
			"signals.se.crossing.base", BlockCrossingGate::new
	);
	public static final BlockEntry<BlockRailroadCrossingController> BLOCK_RAILROAD_CROSSING_CONTROLLER = SwBlocks.modelledBlock("signals.se.crossing.base", BlockRailroadCrossingController::new);
