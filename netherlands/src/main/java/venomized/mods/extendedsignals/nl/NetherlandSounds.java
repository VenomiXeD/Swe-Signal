...
public class NetherlandSounds {
    ...
    public static final DeferredRegister<SoundEvent> SOUNDS = DeferredRegister.create(Registries.SOUND_EVENT, ExtendedSignalsNetherlands.MOD_ID);
    public static final DeferredHolder<SoundEvent, SoundEvent> BELL_VIALIS_EBA = sound(ExtendedSignalsNetherlands.res("vialis_eba"));
