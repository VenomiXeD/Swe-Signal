...
public class BlockHVKMainSignal extends BlockGermanySignal {
    /**
     * @param pProperties
     */
    public BlockHVKMainSignal(Properties pProperties) {
        super(pProperties);
    }
    ...
    public @Nullable BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return GermanyBlockEntities.HVKBlockEntities.HVK_MAIN_SIGNAL.create(pos, state);
    }
}
