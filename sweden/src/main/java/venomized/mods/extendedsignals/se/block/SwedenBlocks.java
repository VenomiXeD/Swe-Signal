...
public final class SwedenBlocks {
    ...
    public static final BlockEntry<Block2SignalModern> SIGNAL_MAIN_2_MODERN = RegistrateHelper
            .modelledBlock(registrate(), "se", "signals", "2l_signal_modern", Block2SignalModern::new)
            .register();

    public static final BlockEntry<Block3SignalModern> SIGNAL_MAIN_3_MODERN = RegistrateHelper
            .modelledBlock(registrate(), "se", "signals", "3l_signal_modern", Block3SignalModern::new)
            .register();

    public static final BlockEntry<Block4CombinedSignal> SIGNAL_COMBINED_4_MODERN = RegistrateHelper
            .modelledBlock(registrate(), "se", "signals", "4l_signal_modern", Block4CombinedSignal::new)
            .register();

    public static final BlockEntry<Block5CombinedSignal> SIGNAL_COMBINED_5_MODERN = RegistrateHelper
            .modelledBlock(registrate(), "se", "signals", "5l_signal_modern", Block5CombinedSignal::new)
            .register();

    // == DISTANT SIGNALS ==
    public static final BlockEntry<BlockModernThreeLightDistantSignal> SIGNAL_DISTANT_3_MODERN = RegistrateHelper
            .modelledBlock(registrate(), "se", "signals", "3l_distant_signal_modern", BlockModernThreeLightDistantSignal::new)
            .register();

    // == DWARF SIGNALS ==
    public static final BlockEntry<BlockModernDwarfSignal> SIGNAL_DWARF_MODERN = RegistrateHelper
            .modelledBlock(registrate(), "se", "signals", "dwarf_signal_modern", BlockModernDwarfSignal::new)
            .register();

    public static final BlockEntry<BlockModernMainDwarfSignal> SIGNAL_MAIN_DWARF_MODERN = RegistrateHelper
            .modelledBlock(registrate(), "se", "signals", "dwarf_main_signal_modern", BlockModernMainDwarfSignal::new)
            .register();

    // == MISC SIGNALS ==
    public static final BlockEntry<BlockModernEndpointSignal> SIGNAL_ENDPOINT = RegistrateHelper
            .modelledBlock(registrate(), "se", "signals", "endpoint_signal_modern", BlockModernEndpointSignal::new)
            .register();
    ...
    public static final BlockEntry<BlockCrossingDistantSignal> SIGNAL_CROSSING_DISTANT_MODERN = RegistrateHelper
            .modelledBlock(registrate(), "se", "signals", "crossing_distant_signal_modern", BlockCrossingDistantSignal::new)
            .register();

    public static final BlockEntry<BlockCrossingSignal> SIGNAL_CROSSING_MODERN = RegistrateHelper
            .modelledBlock(registrate(), "se", "signals", "crossing_signal_modern", BlockCrossingSignal::new)
            .register();

    public static final BlockEntry<BlockCrossingGate> CROSSING_GATE_MODERN = RegistrateHelper
            .modelledBlock(registrate(), "se", "crossings", "base", BlockCrossingGate::new)
            .register();

    public static final BlockEntry<BlockCrossingLights> CROSSING_LIGHTS_MODERN = RegistrateHelper
            .modelledBlock(registrate(), "se", "crossings", "crossing_lights_modern", BlockCrossingLights::new)
            .register();
    ...
    public static final BlockEntry<BlockOnix1500TrainSound> TRAIN_SOUND_X60 = RegistrateHelper
            .modelledBlock(registrate(), "se", "trainsound", "onix1500", BlockOnix1500TrainSound::new)
            .register();
