...
public class ExtendedSignalsSwedenBlocks {
    ...
    public static final BlockEntry<BlockModernTwoLightSignal> BLOCK_TWO_LIGHT_SIGNAL = RegistrateHelper.signalBlock(registrate(), "signals", "se", "2l_signal_post_1970", BlockModernTwoLightSignal::new)
            .register();
    public static final BlockEntry<BlockModernThreeLightSignal> BLOCK_THREE_LIGHT_SIGNAL = RegistrateHelper.signalBlock(registrate(), "signals", "se", "3l_signal_post_1970", BlockModernThreeLightSignal::new)
            .register();
    public static final NonNullSupplier<? extends Block> BLOCK_FOUR_LIGHT_SIGNAL = RegistrateHelper.signalBlock(registrate(), "signals", "se", "4l_signal_post_1970", BlockModernFourLightSignal::new)
            .register();
    public static final BlockEntry<BlockModernFiveLightSignal> BLOCK_FIVE_LIGHT_SIGNAL = RegistrateHelper.signalBlock(registrate(), "signals", "se", "5l_signal_post_1970", BlockModernFiveLightSignal::new)
            .register();
    // == DISTANT SIGNALS ==
    public static final BlockEntry<BlockModernThreeLightDistantSignal> BLOCK_MODERN_THREE_LIGHT_DISTANT_SIGNAL = RegistrateHelper.signalBlock(registrate(), "signals", "se", "3l_distant_signal_post_1970", BlockModernThreeLightDistantSignal::new)
            .register();
    // == DWARF SIGNALS ==
    ...
    public static final BlockEntry<BlockRailroadCrossingSignal> BLOCK_RAILROAD_CROSSING_SIGNAL = RegistrateHelper.signalBlock(registrate(), "signals", "se", "1l_railroad_crossing_signal_2_post_1970", BlockRailroadCrossingSignal::new)
            .register();
    public static final BlockEntry<BlockRailroadCrossingDistantSignal> BLOCK_RAILROAD_CROSSING_DISTANT_SIGNAL = RegistrateHelper.signalBlock(registrate(), "signals", "se", "3l_distant_railroad_crossing_signal_post_1970", BlockRailroadCrossingDistantSignal::new)
            .register();
