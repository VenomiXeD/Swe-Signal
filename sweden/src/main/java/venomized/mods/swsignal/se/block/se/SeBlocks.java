...
import venomized.mc.mods.swsignals.block.se.BlockGenericRotateableBlock;
import venomized.mc.mods.swsignals.block.se.BlockModernDwarfSignal;
...
public class SeBlocks {
    // == SWEDISH CONTENT ==
    public static final BlockEntry<BlockSignalBox> BLOCK_SIGNAL_BOX = AllBlocks.modelledBlock("signal.se.signal_box", BlockSignalBox::new)
            .register();
    // == SIGNALS FROM 2-5 LIGHTS ==
    public static final BlockEntry<BlockModernTwoLightSignal> BLOCK_TWO_LIGHT_SIGNAL = AllBlocks.signalBlock("signal", "se", "2l_signal_post_1970", BlockModernTwoLightSignal::new)
            .register();
    ...
    public static final BlockEntry<BlockModernFiveLightSignal> BLOCK_FIVE_LIGHT_SIGNAL = AllBlocks.signalBlock("signal", "se", "5l_signal_post_1970", BlockModernFiveLightSignal::new)
            .register();
    // == DISTANT SIGNALS ==
    public static final BlockEntry<BlockModernThreeLightDistantSignal> BLOCK_MODERN_THREE_LIGHT_DISTANT_SIGNAL = AllBlocks.signalBlock("signal", "se", "3l_distant_signal_post_1970", BlockModernThreeLightDistantSignal::new)
            .register();
    // == DWARF SIGNALS ==
    public static final BlockEntry<BlockModernDwarfSignal> BLOCK_MODERN_DWARF_SIGNAL = AllBlocks.signalBlock("signal", "se", "4l_dwarf_signal_post_1970", BlockModernDwarfSignal::new)
            .register();
    public static final BlockEntry<BlockModernMainDwarfSignal> BLOCK_MODERN_MAIN_DWARF_SIGNAL = AllBlocks.signalBlock("signal", "se", "7l_dwarf_main_signal_post_1970", BlockModernMainDwarfSignal::new)
            .register();
    // == MISC SIGNALS ==
    ...
    public static final BlockEntry<BlockRailroadCrossingSignal> BLOCK_RAILROAD_CROSSING_SIGNAL = AllBlocks.signalBlock("signal", "se", "1l_railroad_crossing_signal_2_post_1970", BlockRailroadCrossingSignal::new)
            .register();
    public static final BlockEntry<BlockRailroadCrossingDistantSignal> BLOCK_RAILROAD_CROSSING_DISTANT_SIGNAL = AllBlocks.signalBlock("signal", "se", "3l_distant_railroad_crossing_signal_post_1970", BlockRailroadCrossingDistantSignal::new)
            .register();
    public static final BlockEntry<BlockCrossingGate> BLOCK_CROSSING_GATE = AllBlocks.modelledBlock("signal.se.crossing.base", BlockCrossingGate::new)
            .register();
    public static final BlockEntry<BlockRailroadCrossingController> BLOCK_RAILROAD_CROSSING_CONTROLLER = AllBlocks.modelledBlock("signal.se.crossing.controller", BlockRailroadCrossingController::new)
            .register();
    public static final BlockEntry<BlockThreeLightCrossingSignal> BLOCK_THREE_LIGHT_CROSSING_SIGNAL = AllBlocks.signalBlock("crossing", "se", "3l_crossing_lights_post_1970", BlockThreeLightCrossingSignal::new)
            .register();
