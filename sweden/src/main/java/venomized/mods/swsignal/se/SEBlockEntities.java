...
import venomized.mods.extendedsignals.se.block.se.SeBlocks;
...
import venomized.mods.extendedsignals.se.blockentity.BlockEntityUSign;
...
public final class SEBlockEntities {
    ...
    public static final BlockEntityEntry<BlockEntitySignalBox> BE_SE_SIGNAL_BOX =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_signal_box", BlockEntitySignalBox::new, SeBlocks.BLOCK_SIGNAL_BOX)
    ...
    public static final BlockEntityEntry<BlockEntityTwoLightSignal> BE_TWO_LIGHT_SIGNAL =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_2l_signal", BlockEntityTwoLightSignal::new, SeBlocks.BLOCK_TWO_LIGHT_SIGNAL)
                    .renderer(() -> RendererSignal::new)
                    .register();
    public static final BlockEntityEntry<BlockEntityThreeLightSignal> BE_THREE_LIGHT_SIGNAL =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_3l_signal", BlockEntityThreeLightSignal::new, SeBlocks.BLOCK_THREE_LIGHT_SIGNAL)
                    .renderer(() -> RendererSignal::new)
                    .register();
    public static final BlockEntityEntry<BlockEntityFourLightSignal> BE_FOUR_LIGHT_SIGNAL =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_4l_signal", BlockEntityFourLightSignal::new, SeBlocks.BLOCK_FOUR_LIGHT_SIGNAL)
    ...
    public static final BlockEntityEntry<BlockEntityFiveLightSignal> BE_FIVE_LIGHT_SIGNAL =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_5l_signal", BlockEntityFiveLightSignal::new, SeBlocks.BLOCK_FIVE_LIGHT_SIGNAL)
    ...
    public static final BlockEntityEntry<BlockEntityThreeLightDistantSignal> BE_THREE_LIGHT_DISTANT_SIGNAL =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_3l_distant_signal", BlockEntityThreeLightDistantSignal::new, SeBlocks.BLOCK_MODERN_THREE_LIGHT_DISTANT_SIGNAL)
                    .renderer(() -> RendererThreeLightDistantSignal::new)
                    .register();
    // == DWARF SIGNALS ==
    public static final BlockEntityEntry<BlockEntity> BE_DWARF_SIGNAL =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_dwarf_signal", BlockEntityDwarfSignal::new, SeBlocks.BLOCK_MODERN_DWARF_SIGNAL)
                    .renderer(() -> RendererBasicDwarfSignal::new)
                    .register();
    //
    public static final BlockEntityEntry<BlockEntity> BE_MAIN_DWARF_SIGNAL =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_main_dwarf_signal", BlockEntityMainDwarfSignal::new, SeBlocks.BLOCK_MODERN_MAIN_DWARF_SIGNAL)
                    .renderer(() -> RendererMainDwarfSignal::new)
                    .register();
    public static final BlockEntityEntry<BlockEntityEndpointSignal> BE_ENDPOINT_SIGNAL =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_1l_endpoint_signal", BlockEntityEndpointSignal::new, SeBlocks.BLOCK_ENDPOINT_SIGNAL)
    ...
    public static final BlockEntityEntry<BlockEntityRailroadCrossingSignal> BE_RAILROAD_CROSSING_SIGNAL =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_railroad_crossing_signal", BlockEntityRailroadCrossingSignal::new, SeBlocks.BLOCK_RAILROAD_CROSSING_SIGNAL)
    ...
    public static final BlockEntityEntry<BlockEntityRailroadCrossingDistantSignal> BE_RAILROAD_CROSSING_DISTANT_SIGNAL =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_railroad_crossing_distant_signal", BlockEntityRailroadCrossingDistantSignal::new, SeBlocks.BLOCK_RAILROAD_CROSSING_DISTANT_SIGNAL)
    ...
    public static final BlockEntityEntry<BlockEntityCrossingGate> BE_CROSSING_GATE =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_crossing_gate", BlockEntityCrossingGate::new, SeBlocks.BLOCK_CROSSING_GATE)
    ...
    public static BlockEntityEntry<BlockEntityThreeLightCrossingLights> BE_THREE_LIGHT_CROSSING_LIGHT_SIGNAL =
            ExtendedSignalsAllBlockEntities.simpleBlockEntity("be_se_3l_crossing_signal", BlockEntityThreeLightCrossingLights::new, SeBlocks.BLOCK_THREE_LIGHT_CROSSING_SIGNAL)
